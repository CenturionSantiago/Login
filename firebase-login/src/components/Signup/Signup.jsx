...
export function Signup(){
    ...
    const registro = () => {
        if(!values.name || !value.email || !values.pass){
    ...
    return(
        <div className={styles.container} >
            <div className={styles.innerBox} >
                ...
                <InputControl label="Nombre" placeholder="Ingrese un nombre" onChange={
                    (event) => setvalues((prev) => ({...prev, name:event.target.value}))
                } />

                <InputControl label="Email" placeholder="Ingrese un correo" onChange={
                    (event) => setvalues((prev) => ({...prev, email:event.target.value}))
                } />

                <InputControl label="Contraseña" placeholder="Ingrese una contraseña" onChange={
